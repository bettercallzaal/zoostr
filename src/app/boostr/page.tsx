    ...
    <main className="min-h-screen bg-zao-dark">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="bg-zao-card border border-zao-border rounded-xl p-5">
            ...
            <p className="text-sm text-slate-400 leading-relaxed mb-3">
              The music creator whose casts you&rsquo;re boosting. Every like on a ZABAL cast
              counts toward your empire points.
            </p>
      ...
      <section className="max-w-2xl mx-auto px-4 pb-10">
        ...
        <p className="text-xs text-slate-600 mt-3 leading-relaxed">
          The Boostr API doesn&rsquo;t send CORS headers, so Zoostr uses a server-side proxy at
