...
| 279 | `feat/deploy-config-pr-table-276` | deploy-config.md: update PR merge table 275→278 rows; "After all 275 PRs" → "After all 279 PRs" |

After all 279 PRs are merged to `main`:
