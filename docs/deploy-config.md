...
| 272 | `feat/deploy-config-pr-table-271` | deploy-config.md: update PR merge table 270→271 rows; "After all 270 PRs" → "After all 272 PRs" |

After all 272 PRs are merged to `main`:
